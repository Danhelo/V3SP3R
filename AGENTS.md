...
Uses tool-calling (function calling) API. System prompt and tool definitions are in `VesperPrompts`. The agent loop runs up to 10 tool-call iterations per user message. Models recommended: Hermes 4, Codex Sonnet 4, Codex Opus 4.6.
